...
public class Main {
    ...
    private static void adminOperations() {
        ...
        System.out.println(ANSI_CYAN + "2. View All Messages");
...
private static void viewAllMessages() {
    List<Message> messages = adminController.getAllMessages();
    if (messages.isEmpty()) {
        System.out.println(ANSI_YELLOW + "No messages found." + ANSI_RESET);
    } else {
        System.out.println(ANSI_GREEN + "List of Messages:" + ANSI_RESET);
